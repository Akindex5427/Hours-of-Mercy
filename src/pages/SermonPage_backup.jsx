...
const SermonPage = () => {
  ...
  // Firebase hooks
  const { sermons, loading, error } = useSermons(20); // Get 20 recent sermons
  ...
  return (
    <>
      ...
      {/* Video Player Modal - Now redirects to Facebook */}
      {selectedSermon && (
        <Box
          sx={{
            position: "fixed",
                ...
                <Grid container spacing={4}>
                  {filteredSermons
                    .filter((sermon) => {
                      ...
                      if (selectedTab === 2) return sermon.videoUrl; // Video sermons only
                      return true;
                    })
                    .map((sermon, index) => (
                          ...
                          <Box
                            sx={{
                              ...
                              "&::after": {
                                ...
                                right: 0,
                                bottom: 0,
                                background: "linear-gradient(45deg, transparent 0%, rgba(25,118,210,0.1) 100%)",
                                pointerEvents: "none",
                              }
                            }}
                          >
